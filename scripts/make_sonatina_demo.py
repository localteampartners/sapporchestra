#!/usr/bin/env python3
"""Render a short orchestral piece with Sonatina Symphonic Orchestra through
...
LIB = sys.argv[2] if len(sys.argv) > 2 else os.path.expanduser(
    "~/Samples/sonatina/Sonatina Symphonic Orchestra")
OUT = sys.argv[3] if len(sys.argv) > 3 else "/tmp/sapporchestra-sonatina-demo.wav"
TPQ = 480
BPM = 76
...
stems.append(("1st Violins KS", "Strings - Notation/1st Violins KS.sfz", "violin1", v1, 1.0))
...
stems.append(("2nd Violins", "Strings - Notation/2nd Violins Sustain.sfz", "violin2", pad, 0.85))
...
stems.append(("Violas", "Strings - Notation/Violas Sustain.sfz", "viola", violas, 0.8))
...
stems.append(("Celli", "Strings - Notation/Celli Sustain.sfz", "cello", celli, 0.95))
...
stems.append(("Basses", "Strings - Notation/Basses Pizzicato.sfz", "bass", basses, 0.9))
...
stems.append(("Horns", "Brass - Notation/Horns KS.sfz", "horn", horns, 0.85))

# Timpani: cadence accents.
timp = []
for t, vel in [(12.0, 90), (28.0, 96), (32.0, 118), (34.0, 70)]:
    note(timp, t, 1.0, 38, vel)
stems.append(("Timpani", "Percussion/Timpani.sfz", "timpani", timp, 1.0))
...
for name, rel, seat, events, gain in stems:
    ...
    if not os.path.exists(sfz):
        ...
        continue
    mid = f"/tmp/sonatina-{seat}.mid"
    wav = f"/tmp/sonatina-{seat}.wav"
